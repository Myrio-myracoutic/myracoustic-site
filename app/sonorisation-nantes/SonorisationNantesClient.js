...
function AudienceCard({ tag, title, desc, href, cta }) {
  return (
    <div style={{
      ...
      <h3 style={{
        fontFamily: 'var(--font-display), sans-serif',
        fontSize: 24, fontWeight: 700, margin: '10px 0 12px',
      }}>{title}</h3>
...
const ZONES = [
  'Nantes', 'Nort-sur-Erdre', 'Angers', 'Rennes', 'Saint-Nazaire', 'Pays de la Loire', 'Bretagne', 'Poitou-Charentes',
];

/* ─── Page ──────────────────────────────────────────────────────── */
export default function SonorisationNantesClient() {
  return (
      ...
      <section style={{ padding: 'clamp(56px,7vw,88px) 32px', background: '#060e16' }}>
        <div style={{ maxWidth: 1280, margin: '0 auto' }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.45)', fontSize: 15, lineHeight: 1.7, maxWidth: 640, marginBottom: 36 }}>
            Quel que soit votre événement, Myracoustic conçoit et exploite un dispositif technique cohérent, de la sonorisation à l'animation.
          </p>
      ...
      <section style={{ padding: 'clamp(56px,7vw,88px) 32px' }}>
        <div style={{ maxWidth: 1280, margin: '0 auto' }}>
          ...
          <h2 style={{
            ...
            Basé à Nort-sur-Erdre, au plus proche de <span style={{ color: 'var(--lime)' }}>Nantes</span>
          </h2>
          <p style={{ color: 'rgba(255,255,255,0.45)', fontSize: 15, lineHeight: 1.7, maxWidth: 640, marginBottom: 28 }}>
            Nantes est notre zone d'intervention principale. Nous intervenons également dans les villes et régions suivantes :
          </p>
        ...
        <div style={{ maxWidth: 1280, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(300px,1fr))', gap: 24 }}>
            <AudienceCard
              ...
              desc="Sonorisation, éclairage et animation DJ pour mariages, anniversaires et réceptions privées à Nantes et en Pays de la Loire."
            ...
            <AudienceCard
              ...
              desc="Sonorisation professionnelle, éclairage, écran LED et régie technique pour vos séminaires, conventions et galas de 80 à 400 personnes."
        ...
        <div style={{ maxWidth: 760, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 40 }}>
            ...
            <h2 style={{
              ...
              Sonorisation à Nantes : vos questions
            </h2>
          </div>
