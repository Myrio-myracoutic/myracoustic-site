...
/* Inverse de parisLocalToUtcISO : un instant UTC réel → { date: 'YYYY-MM-DD', time: 'HH:mm' }
   en heure de Paris. Utile pour reformater un call_scheduled_at (stocké en UTC) avant de le
   passer à fmtSlotDateTime, qui attend une date+heure locale Paris. */
export function utcToParisParts(isoUtc) {
...
/* Date calendaire (YYYY-MM-DD) à Paris, décalée de `days` jours par rapport à aujourd'hui. */
export function parisDatePlusDays(days) {
