...
export default function TestimonialCarousel({ items }) {
  ...
  return (
    <>
      {/* Ordinateur, ≤ 4 avis : grille fixe (pas de carrousel) */}
      {!forceCarousel && (
      ...
      {/* Carrousel : mobile toujours ; ordinateur seulement si > 4 avis */}
      <div className={forceCarousel ? undefined : 'hide-desktop'} style={{ position: 'relative' }}>
        ...
        {items.length > 1 && (
          <>
            ...
            {/* Points de pagination — nombre d'avis + position active */}
